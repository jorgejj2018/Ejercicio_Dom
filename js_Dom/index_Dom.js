...
import ResponsTester from "./responsive_tester.js";
import userAgent from "./user_agent.js";
import geo from "./geolocalizacion.js";
import filterCards from "./cards_filter.js";
import draw from "./Sorteo.js";
import scrollSpy from "./scroll_spy.js";
import clipInteligent from "./video_inteligente.js";
import contactValidacionForm from "./validacion_form.js";
import speedReader from "./narrador.js";
...
d.addEventListener('DOMContentLoaded', (e) =>{
    ...
    ResponsTester('reponsive-tester')
    userAgent('user-agent')
    geo('geolocalizacion')
    filterCards('.cardF','.card')
    draw('btn-w' , '.player')
    scrollSpy()
    clipInteligent()
    contactValidacionForm()
